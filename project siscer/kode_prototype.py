...
#CONTOH KASUS MANUAL 
print("\n" + "="*40)
print("       TES DIAGNOSA MANUAL")
print("="*40)

# Input Manual: Umur 20, BMI 25, Gula Darah 120
contoh_bmi = 25
contoh_umur = 20
contoh_gula = 120

skor_contoh, kategori_contoh = prediksi_single(contoh_bmi, contoh_umur, contoh_gula)

print(f"Input Data Pasien:")
print(f" - Umur        : {contoh_umur} tahun")
print(f" - BMI         : {contoh_bmi}")
print(f" - Gula Darah  : {contoh_gula} mg/dL")
print("-" * 30)
print(f"Hasil Diagnosa Fuzzy:")
print(f" -> Skor Risiko : {skor_contoh:.2f} / 100")
print(f" -> KESIMPULAN  : RISIKO {kategori_contoh.upper()}")
print("="*40)
